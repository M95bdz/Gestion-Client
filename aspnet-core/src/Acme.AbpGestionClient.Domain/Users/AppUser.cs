...
namespace Acme.AbpGestionClient.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpGestionClientDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpGestionClientEfCoreEntityExtensionMappings to extend the IdentityUser entity
